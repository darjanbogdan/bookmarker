...
namespace Bookmarker_UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = new BookmarkerPackage() as IVsPackage;
            ...
            CommandID menuCommandID = new CommandID(Bookmarker.GuidList.guidBookmarkerCmdSet, (int)Bookmarker.PkgCmdIDList.cmdidBookmarker);
